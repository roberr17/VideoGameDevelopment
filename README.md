...
#### 1. The Incredible Machine (Físicas 2D)
...
#### 2. Tank Game (Arquitectura y Control)
...
#### 3. Lighting and Shaders (Programación Gráfica)
...
#### 4. Tomb of the Mask Inspiration (Mecánicas Arcade)
...
#### 5. Procedural Generation & Pathfinding (PCG + Nav)
...
#### 6. Minmax & Alpha-Beta Pruning (IA Estratégica)
...
* **[Roberto]** - *Desarrollador de Software & Game AI* - [Yo](https://github.com/roberr17)
